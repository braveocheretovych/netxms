...
static bool H_UpgradeFromV10()
{
   static const TCHAR *batch =
      _T("ALTER TABLE policy_action_list ADD inactive char(1)\n")
      _T("UPDATE policy_action_list SET inactive='0'\n")
      _T("<END>");
   CHK_EXEC(SQLBatch(batch));
   CHK_EXEC(DBSetNotNullConstraint(g_dbHandle, _T("policy_action_list"), _T("inactive")));
